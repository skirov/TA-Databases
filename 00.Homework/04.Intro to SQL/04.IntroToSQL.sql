...
SELECT e.FirstName + ' ' + e.LastName + ' -> Manager: ' + m.FirstName + ' ' + m.LastName FROM Employees e
...
SELECT  e.FirstName + ' ' + e.LastName AS Employee, d.Name AS Department FROM Employees e 
